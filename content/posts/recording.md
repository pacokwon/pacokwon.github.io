...
내 스스로의 모습에 더 떳떳하게 되는 것도 있다. 난 남에게 비춰지는 나의 모습을 알게 모르게 많이 신경쓴다. 영상을 편집하지 않는 이유는 분량 때문에 엄두가 안 나는 것도 있지만, 그냥 내 모습에 체념하고 눈치보는 데에 에너지를 덜 쓰고 싶었다. 지인 말고는 영상을 볼 일이 없는 것을 알지만, 아무도 보지 않는다 생각해도 의외로 효과가 있더라.
